"""
Train identifier detection - optimized for speed.

Based on v2 but with fewer OCR calls:
1. Single preprocessing pass per text column (not 3)
2. Skip colored text detection (rarely produces results)
3. No retry OCR for symbols
"""
...
class TrainDetectorV3:
    ...
    def detect_trains(self, image):
        """Detect trains - optimized version of v2."""
        if not TESSERACT_AVAILABLE:
            return []
