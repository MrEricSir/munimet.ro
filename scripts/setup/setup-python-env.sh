...
echo "  cd $PROJECT_ROOT/training && source venv/bin/activate"
echo "  cd $PROJECT_ROOT/api && source venv/bin/activate"
echo "  cd $PROJECT_ROOT/tests && source venv/bin/activate"
echo ""
echo "Next steps:"
echo "1. Download training data: ./scripts/sync-training-data.sh download"
echo "2. Download models: ./scripts/sync-models.sh download"
echo "3. Follow SETUP.md for project-specific configuration"
echo ""
